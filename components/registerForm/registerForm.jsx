...
export default function RegisterForm() {
    ...
    const [formData, setFormData] = useState({
        name: "", email: "", password: "", confirmPassword: "", api_key: "", prop_key: "",
    });
                        ...
                        >
                            ...
                            <div className="mt-1 relative rounded-md shadow-sm">
                                <input
                                    ...
                                    className={`appearance-none block w-full px-3 py-2 border ${errors[field] ? "border-red-300" : "border-gray-300"} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition duration-150 ease-in-out`}
                                />
                                {errors[field] && (<div
