        ...
        <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="p-6 space-y-4">
                <p className="text-gray-800 text-lg">
                    We're thrilled to have you join our team as a <span
                    className="font-semibold text-indigo-600">{role}</span>.
                </p>
                <p className="text-gray-700">
                    Your account has been successfully created. Here are your login details:
                </p>
                <div className="bg-gray-100 p-4 rounded-lg">
                    <p className="text-sm text-gray-600">Email: <span
                        className="font-medium">{email}</span></p>
                    <p className="text-sm text-gray-600">Password: <span className="font-medium">{password}</span></p>
                </div>
                <p className="text-gray-700">
                    For security reasons, we recommend changing your password upon your first login.
                </p>
                <div className="mt-6">
                    <a href="https://www.taskspro.live"
