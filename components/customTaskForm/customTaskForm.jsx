...
const CustomTaskForm = () => {
  ...
  const form = ReactHookForm.useForm({
    defaultValues: {
      taskTitle: prefillData?.guestName ? `Driver task for ${prefillData.guestName}` : "",
      taskDescription: "",
      role: "Driver",
      guestFirstName: prefillData?.guestFirstName || "",
      guestName: prefillData?.guestName || "",
      location: "",
      guestPhone: prefillData?.guestPhone || "",
